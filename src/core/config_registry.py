...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MACRO_NEWS_ENABLED": {
        "title": "宏观新闻增强",
        "description": "分析时附加宏观/市场层面新闻（美联储、政策、大盘走势），供多点影响分析使用；关闭后恢复纯个股新闻。",
        "category": "data_source",
        "data_type": "bool",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 32,
        "help_key": "settings.data_source.search_api_keys",
        "examples": ["MACRO_NEWS_ENABLED=true"],
        "docs": [
            {
                "label": "宏观新闻增强",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
    ...
    "MACRO_NEWS_MAX_RESULTS": {
        "title": "宏观新闻条数上限",
        "description": "每次分析附加的宏观新闻条数上限。",
        "category": "data_source",
        "data_type": "int",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 33,
        "help_key": "settings.data_source.search_api_keys",
        "examples": ["MACRO_NEWS_MAX_RESULTS=5"],
        "docs": [
            {
                "label": "宏观新闻条数上限",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
    ...
    "MACRO_NEWS_REFRESH_HOURS": {
        "title": "宏观新闻刷新间隔（小时）",
        "description": "宏观新闻快照的刷新间隔；同一市场全用户共享一份快照。0 = 当日只抓取一次。",
        "category": "data_source",
        "data_type": "int",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 34,
        "help_key": "settings.data_source.search_api_keys",
        "examples": ["MACRO_NEWS_REFRESH_HOURS=6"],
        "docs": [
            {
                "label": "宏观新闻刷新间隔（小时）",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
