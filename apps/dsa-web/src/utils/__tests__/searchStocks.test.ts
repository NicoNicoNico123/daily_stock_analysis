...
const mockIndex: StockIndexItem[] = [
  ...
  },
  {
    ...
    pinyinAbbr: "ftqc",
    aliases: ["Toyota", "Toyota Motor", "豐田"],
    market: "JP",
    assetType: "stock",
    active: true,
    popularity: 97,
